...
class IkamiAdmServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->publishes([
            ...
            __DIR__.'/database/migrations/create_jawaban_pilihan_table.php' => database_path('migrations/'.date('Y_m_d_His', strtotime('1986-01-17 00:00:14')).'_create_jawaban_pilihan_table.php'),
            __DIR__.'/database/migrations/create_kesiapan_table.php' => database_path('migrations/'.date('Y_m_d_His', strtotime('1986-01-17 00:00:15')).'_create_kesiapan_table.php'),
            __DIR__.'/database/migrations/create_kematangan_table.php' => database_path('migrations/'.date('Y_m_d_His', strtotime('1986-01-17 00:00:16')).'_create_kematangan_table.php'),
            __DIR__.'/database/migrations/create_pertanyaan_table.php' => database_path('migrations/'.date('Y_m_d_His', strtotime('1986-01-17 00:00:17')).'_create_pertanyaan_table.php'),
            __DIR__.'/database/migrations/create_penyaringan_awal_table.php' => database_path('migrations/'.date('Y_m_d_His', strtotime('1986-01-17 00:00:18')).'_create_penyaringan_awal_table.php'),
            __DIR__.'/database/migrations/create_kematangan_baru_table.php' => database_path('migrations/'.date('Y_m_d_His', strtotime('1986-01-17 00:00:19')).'_create_kematangan_baru_table.php'),
            __DIR__.'/database/migrations/create_pemeringkatan_table.php' => database_path('migrations/'.date('Y_m_d_His', strtotime('1986-01-17 00:00:20')).'_create_pemeringkatan_table.php'),
            ...
            __DIR__.'/database/migrations/create_opini_table.php' => database_path('migrations/'.date('Y_m_d_His', strtotime('1986-01-17 00:00:22')).'_create_opini_table.php'),
            __DIR__.'/database/migrations/create_opini_sistem_el_table.php' => database_path('migrations/'.date('Y_m_d_His', strtotime('1986-01-17 00:00:23')).'_create_opini_sistem_el_table.php'),
            __DIR__.'/database/migrations/create_asesmen_table.php' => database_path('migrations/'.date('Y_m_d_His', strtotime('1986-01-17 00:00:24')).'_create_asesmen_table.php'),
            __DIR__.'/database/migrations/create_informasi_table.php' => database_path('migrations/'.date('Y_m_d_His', strtotime('1986-01-17 00:00:25')).'_create_informasi_table.php'),
            __DIR__.'/database/migrations/create_area_utama_table.php' => database_path('migrations/'.date('Y_m_d_His', strtotime('1986-01-17 00:00:26')).'_create_area_utama_table.php'),
            __DIR__.'/database/migrations/create_aspek_suplemen_table.php' => database_path('migrations/'.date('Y_m_d_His', strtotime('1986-01-17 00:00:27')).'_create_aspek_suplemen_table.php'),
            __DIR__.'/database/migrations/create_penugasan_table.php' => database_path('migrations/'.date('Y_m_d_His', strtotime('1986-01-17 00:00:28')).'_create_penugasan_table.php'),
            __DIR__.'/database/migrations/create_dokumen_da_table.php' => database_path('migrations/'.date('Y_m_d_His', strtotime('1986-01-17 00:00:29')).'_create_dokumen_da_table.php'),
            __DIR__.'/database/migrations/create_statuses_table.php' => database_path('migrations/'.date('Y_m_d_His', strtotime('1986-01-17 00:00:30')).'_create_statuses_table.php'),
        ], 'ikami-migration');
